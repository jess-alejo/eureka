...
class NuggetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create nugget" do
    assert_difference('Nugget.count') do
      post nuggets_url, params: { nugget: { content: @nugget.content, title: @nugget.title } }
    end
  ...
  test "should update nugget" do
    patch nugget_url(@nugget), params: { nugget: { content: @nugget.content, title: @nugget.title } }
